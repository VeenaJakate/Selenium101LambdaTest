...
public class SeleniumTestScenarios {
    ...
    private final String username = "veena_karoshi";
    private final String accessKey = "y78X16dvVY7btVvXf0LlRDPceZMD20ohvrJulSwM1eI2zgasbI";
    ...
    private final String expectedValidationMessage = "Please fill out this field.";
    ...
    private void fillInputForm() {
        ...
        password.sendKeys("password203");
        company.sendKeys("ABC Company");
        website.sendKeys("https://abc.com");
